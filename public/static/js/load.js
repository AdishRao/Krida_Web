...
<!--
  <ul class="sidenav nav-center sidenav-fixed invesible-top " id="mobile-nav">
    <li class="tooltipped" data-position="right" data-tooltip="Welcome"><a style="border-radius: 36px; margin-top:8px; margin-right:10px; margin-left:10px; font-size:18px" class=" text-black center teal lighten-2  ">Amaatra</a></li>
    <li><div class="divider"></div></li>
    <li><a href="#!" ><i class="material-icons">add</i>New Student</a></li>
    <li><a href="#!"><i class="material-icons">people</i>Existing Student</a></li>
        ...
        <div class="center row">
            <div class="col s4"></div>
              <div class="center col s4">
                ...
                <a id="submit" class="waves-effect waves-dark btn  teal accent-4 lighten-2"  style="margin-top:30px">Submit</a>
            </div>
        </div>
    </form>
    </div>
